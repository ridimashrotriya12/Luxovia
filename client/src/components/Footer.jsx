...
const Footer = () => {
    return (
        <div className='bg-blue-50 text-gray-700 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    <img src={assets.appLogo} alt="appLogo" className='mb-4 h-30   md:h-30 invert opacity-80' />
                    <p className='text-sm'>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} Luxovia. All rights reserved.</p>
